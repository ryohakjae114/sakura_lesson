100.times do
  ...
  3.times do |time|
    ...
    lesson.lesson_dates.create!(date: today.to_date + time, start_time: '12:00:00', end_time: '15:00:00', capacity: rand(1..100), url: "https://example.com#{('a'..'z').to_a.sample(8).join}")
  end
end
